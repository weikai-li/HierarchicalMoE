...
from utils import get_src_path, get_model_info_as_str, get_host, \
...
class Saver(object):
    def __init__(self, ensemble_base_kernel=None):
        ...
        if FLAGS.finetune and len(poly_KERNEL) > 1:
            model_specific = model_specific + '_all_target_kernle_finetune'
